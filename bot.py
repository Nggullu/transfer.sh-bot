...
api_id = int("1693574")
api_hash = "ae31eac17d0ca6c5bfc13302bbc24310"
bot_token = "1391511043:AAG5vIWXcstBwhWkfPAt-FRp0Ua5pUvnaB4"
...
async def start(event):
    ...
    await event.respond('Hi!\n Join @StreamableMovie Sent any file or direct download link to upload and get the transfer.sh download link')
